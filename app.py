...
def page_activiteiten():
    ...
    for _, row in df.sort_values(["datum", "tijd"], na_position="last").iterrows():
        ...
        # Rechterkolom met ✅/❌ totalen per activiteit
        col_left, col_right = st.columns([8, 2])
        with col_right:
            # Tellen incl. extra personen uit meal_choice.guests
...
if __name__ == "__main__":
    st.markdown("<div style='color:red;'>KALENDER ANWW</div>", unsafe_allow_html=True)
